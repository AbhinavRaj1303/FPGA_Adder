...
HD_PWD='/home/fpga/Desktop/clock_sync/clock_sync.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_.tcl
