...
HD_PWD='/home/fpga/Desktop/clock_sync/clock_sync.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_.tcl -notrace
