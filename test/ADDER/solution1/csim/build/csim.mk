...
HLS_SOURCES = ../../../../tstbnch.cpp ../../../../adder.cpp
...
$(ObjDir)/tstbnch.o: ../../../../tstbnch.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../tstbnch.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) -DNDEBUG $< -o $@ ; \

-include $(ObjDir)/tstbnch.d
