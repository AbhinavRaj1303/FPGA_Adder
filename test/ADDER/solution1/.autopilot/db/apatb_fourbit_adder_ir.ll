; ModuleID = '/home/fpga/Desktop/test/ADDER/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: inaccessiblemem_or_argmemonly noinline willreturn
define void @apatb_fourbit_adder_ir(i1 zeroext %a0, i1 zeroext %a1, i1 zeroext %a2, i1 zeroext %a3, i1 zeroext %b0, i1 zeroext %b1, i1 zeroext %b2, i1 zeroext %b3, i1* noalias nocapture nonnull dereferenceable(1) %s0, i1* noalias nocapture nonnull dereferenceable(1) %s1, i1* noalias nocapture nonnull dereferenceable(1) %s2, i1* noalias nocapture nonnull dereferenceable(1) %s3, i1* noalias nocapture nonnull dereferenceable(1) %c3) local_unnamed_addr #0 {
entry:
  %s0_copy = alloca i1, align 512
  %s1_copy = alloca i1, align 512
  %s2_copy = alloca i1, align 512
  %s3_copy = alloca i1, align 512
  %c3_copy = alloca i1, align 512
  call fastcc void @copy_in(i1* nonnull %s0, i1* nonnull align 512 %s0_copy, i1* nonnull %s1, i1* nonnull align 512 %s1_copy, i1* nonnull %s2, i1* nonnull align 512 %s2_copy, i1* nonnull %s3, i1* nonnull align 512 %s3_copy, i1* nonnull %c3, i1* nonnull align 512 %c3_copy)
  call void @apatb_fourbit_adder_hw(i1 %a0, i1 %a1, i1 %a2, i1 %a3, i1 %b0, i1 %b1, i1 %b2, i1 %b3, i1* %s0_copy, i1* %s1_copy, i1* %s2_copy, i1* %s3_copy, i1* %c3_copy)
  call void @copy_back(i1* %s0, i1* %s0_copy, i1* %s1, i1* %s1_copy, i1* %s2, i1* %s2_copy, i1* %s3, i1* %s3_copy, i1* %c3, i1* %c3_copy)
  ret void
}
...
declare void @apatb_fourbit_adder_hw(i1, i1, i1, i1, i1, i1, i1, i1, i1*, i1*, i1*, i1*, i1*)
...
define void @fourbit_adder_hw_stub_wrapper(i1, i1, i1, i1, i1, i1, i1, i1, i1*, i1*, i1*, i1*, i1*) #4 {
entry:
  call void @copy_out(i1* null, i1* %8, i1* null, i1* %9, i1* null, i1* %10, i1* null, i1* %11, i1* null, i1* %12)
  call void @fourbit_adder_hw_stub(i1 %0, i1 %1, i1 %2, i1 %3, i1 %4, i1 %5, i1 %6, i1 %7, i1* %8, i1* %9, i1* %10, i1* %11, i1* %12)
  call void @copy_in(i1* null, i1* %8, i1* null, i1* %9, i1* null, i1* %10, i1* null, i1* %11, i1* null, i1* %12)
  ret void
}

declare void @fourbit_adder_hw_stub(i1, i1, i1, i1, i1, i1, i1, i1, i1*, i1*, i1*, i1*, i1*)
